...
public class BrokerListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new BrokerRecyclerViewAdapter(this, selectedRow, new BrokerRecyclerViewAdapter.RowSelectionListener() {
            @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.action_add:
                Intent intent = new Intent(this, EditBrokerActivity.class);
                // intent.putExtra(LoginActivity.EMAIL, mail);
                intent.putExtra(EditBrokerActivity.MODE, EditBrokerActivity.MODE_ADD);
                if (!mActivityStarted) {
                    mActivityStarted = true;
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.action_remove_broker, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    if (a instanceof BrokerListActivity) {
                        ((BrokerListActivity) a).deleteBroker(selRow);
                    }
                }
            });
    ...
    private final static String TAG = BrokerListActivity.class.getSimpleName();
    ...
    private BrokerRecyclerViewAdapter mAdapter;
